...
10/11/2023
ASIXcA M03 UF1 A3
Descripció: L'usuari introdueix la lletra del tipus d'habitatge i número de m³ d'aigua gastats. Mostrar per pantalla el preu total de la factura de l’aigua.
...
#Asignarem un tram diferent depenent del número de m³ d'aigua gastats
if 0<=aigua<7:
    tram= 1
elif 7<=aigua<10:
    tram= 2
...
#el preu per m³ d'aigua gastats varia depenent del tram
match tram:
